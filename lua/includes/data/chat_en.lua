...
AL("InvestigateCorpse", "I found a body!")
AL("InvestigateCorpse", "I found a dead body!")
AL("InvestigateCorpse", "Found a body.")
AL("InvestigateCorpse", "Body over here!")
AL("InvestigateCorpse", "Found a corpse!")
AL("InvestigateCorpse", "Found a dead body!")
AL("InvestigateCorpse", "Found a body over here!")
ALRT("InvestigateCorpse", "there's a corpse over here", chillTraits)
ALRT("InvestigateCorpse", "there's a body over here", chillTraits)
ALRT("InvestigateCorpse", "corpse", chillTraits)
ALRT("InvestigateCorpse", "body here", chillTraits)
